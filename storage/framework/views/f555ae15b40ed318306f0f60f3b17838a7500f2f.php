...
<html lang="en">
  ...
  <body>
            ...
            <div class="header">
                <div class="bg-img">
                  <div class="row">
                    ...
                    <div class="col-6 ">
                      <img src="<?php echo e(asset('img/4.png')); ?>" class="w-100 h-100 pt mx-auto"  alt="">
                    </div>
                  </div>
                </div>
        </header>
        ...
        <section class="container my-4 d-flex flex-row course-flex  " id="courses">
                    ...
                    <div class="course col-6 w-25 m-3  shadow text-center position-relative">
                      <div class="course-bg rounded w-100   ">
                        ...
                        <div class="icon">
                         <img src="<?php echo e(voyager::image($course -> feature_image )); ?>" width="100" height="" alt="IMG no uploaded"/>
                        </div>
                <div class="course-info p-4">
                  
                  <h3 class="course-name"><?php echo e($course -> titel); ?> </h3>
                  <p class="course-description"><?php echo e($course -> description); ?></p>
                  <hr>
                  <h5 class="p-2">Prise:<span><?php echo e($course -> price); ?></span></h5>
                </div>
              </div>
            </div>
    ...
    <section class="container pe-3 my-4">
      ...
      <div class="row">
        ...
        <div class="rate card col-3">
          <div class="img">
            <img src="<?php echo e(asset('img/f3 (1).jpg')); ?>"   alt="">
          </div>
          <div class="icons">
      ...
      <div class="rate card col-3">
        <div class="img">
          <img src="<?php echo e(asset('img/f3.jpg')); ?>"   alt="">
        </div>
        <div class="icons">
          <i class="fa-solid fa-star star"></i>
          <i class="fa-solid fa-star star"></i>
      ...
      <div class="rate card col-3">
        <div class="img">
          <img src="<?php echo e(asset('img/f3 (3).jpg')); ?>"   alt="">
        </div>
        <div class="icons">
          <i class="fa-solid fa-star star"></i>
          <i class="fa-solid fa-star star"></i>
      ...
      <div class="rate card col-3">
        <div class="img">
          <img src="<?php echo e(asset('img/f3 (2).jpg')); ?>"   alt="">
        </div>
        <div class="icons">
          <i class="fa-solid fa-star star"></i>
          <i class="fa-solid fa-star star"></i>
    ...
    <script src="<?php echo e(asset('js/script_index.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\lms\resources\views/index.blade.php ENDPATH**/ ?>